...
type Repository interface {
	...
	FindByBranchID(ctx context.Context, branchID primitive.ObjectID) ([]*domain.Request, error)
	FindPendingByBranchID(ctx context.Context, branchID primitive.ObjectID) ([]*domain.Request, error)
